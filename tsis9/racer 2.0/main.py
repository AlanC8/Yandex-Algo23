...
while True:
    ...
    if deadscreen:
        ...
        tex1 = f2.render("TOTAL SCORE:{}".format(
            str(SCORE)), True, (255, 255, 255))
        rect = tex1.get_rect()
        rect.center = (200, 470)

        tex2 = f2.render("ORANGE:{}".format(
            str(SCOREORANGE)), True, (255, 255, 255))
        rect2 = tex2.get_rect()
        rect2.center = (200, 505)

        tex3 = f2.render("BANANA:{}".format(
            str(SCOREBANANA)), True, (255, 255, 255))
        rect3 = tex3.get_rect()
