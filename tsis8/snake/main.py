...
class FRUIT:
    ...
    def draw_f(self):
        fruit_rect = pg.Rect(
            self.pos.x*cell_s, self.pos.y*cell_s, cell_s, cell_s)
...
class SNAKE:
    ...
    def update_head_graphics(self):
        ...
        if head_relation == vt(1, 0):
            self.head = self.head_left
        elif head_relation == vt(-1, 0):
            self.head = self.head_right
        elif head_relation == vt(0, 1):
    ...
    def update_tail_graphics(self):
        ...
        if tail_relation == vt(1, 0):
            self.tail = self.tail_left
        elif tail_relation == vt(-1, 0):
            self.tail = self.tail_right
        elif tail_relation == vt(0, 1):
...
class MAIN:
    ...
    def draw_score(self):
        ...
        apple_rect = shashlyk.get_rect(
            midright=(score_rect.left, score_rect.centery))
        bg_rect = pg.Rect(apple_rect.left, apple_rect.top,
